...
// ============================================================================
// Chat Types (from chat_models.py)
// ============================================================================
...
export type ChatStreamEventType = 'chunk' | 'tool' | 'error' | 'done';
...
export type ChatStreamEvent = ChatStreamChunk | ChatStreamTool | ChatStreamError | ChatStreamDone;
